            ...
            <div class="card-style mb-30">
                <div class="col-sm-6  m-auto justify-content-center">
                    ...
                    <div class="input-style-1">
                        ...
                        <input type="text" name="nama" placeholder="Nama Lengkap" value="<?= $arsip_surat->nama ?>" />
                    </div>
                    ...
                    <div class="input-style-1">
                        ...
                        <input type="text" name="no_surat" placeholder="Nomor Surat"
                            value="<?= $arsip_surat->no_surat ?>" />
                    </div>
                    <div class="input-style-1">
                        <label>Alamat</label>
                        <input type="text" name="alamat" placeholder="Alamat" value="<?= $arsip_surat->alamat ?>" />
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="select-style-1">
                    ...
                    <embed class="mt-3" src="<?= base_url('uploads_file/' . $arsip_surat->file_arsip) ?>"
