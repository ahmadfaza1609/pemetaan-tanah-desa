        ...
        <div class="col-lg-12">
            <div class="card-style mb-30">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <?php
                        echo form_open_multipart('lahan/LahanTanah/ubahLahanTanah/' . $tanah_warga->id_lahan_warga); ?>
                                ...
                                <div class="select-position">
                                    <select name="id_penduduk" aria-label="Default select example">
                                        ...
                                        <option value="<?= $value->id_penduduk ?>"
                                            <?= $value->id_penduduk == $tanah_warga->id_penduduk ? 'selected' : '' ?>>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <p><?= $value->nik ?></p>
                                ...
                                <div class="form-group">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" class="form-control" name="panjang"
                                            value="<?= $tanah_warga->panjang ?>" placeholder="Panjang Lahan">
                                ...
                                <div class="form-group">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" class="form-control" name="lebar"
                                            value="<?= $tanah_warga->lebar ?>" placeholder="Lebar Lahan">
                                ...
                                <div class="form-group">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" class="form-control" name="luas"
                                            value="<?= $tanah_warga->luas ?>" placeholder="Luas Lahan">
                        ...
                        <div class="col-sm-12">
                            <img src="<?= base_url('gambar/' . $tanah_warga->file_gambar); ?>" width="100">
                        </div>
                        <div class="form-group">
                            <div class="input-style-1">
                                <div class="input-style-1">
                        ...
                        <div class="form-group">
                            <div class="input-style-1">
                                ...
                                <textarea class="form-control" name="denah_tanah" rows="3"
                                    placeholder="Titik Kordinat"><?= $tanah_warga->denah_tanah ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-style-1">
                                ...
                                <input type="text" class="form-control" name="batas_barat"
                                    value="<?= $tanah_warga->batas_barat ?>" placeholder="Batas Barat">
                        ...
                        <div class="form-group">
                            <div class="input-style-1">
                                ...
                                <input type="text" class="form-control" name="batas_selatan"
                                    value="<?= $tanah_warga->batas_selatan ?>" placeholder="Batas Selatan">
                        ...
                        <div class="form-group">
                            <div class="input-style-1">
                                ...
                                <input type="text" class="form-control" name="batas_utara"
                                    value="<?= $tanah_warga->batas_utara ?>" placeholder="Batas Utara">
                        ...
                        <div class="form-group">
                            <div class="input-style-1">
                                ...
                                <input type="text" class="form-control" name="batas_timur"
                                    value="<?= $tanah_warga->batas_timur ?>" placeholder="Batas Timur">
...
var drawnItems = new L.geoJSON(<?= $tanah_warga->denah_tanah ?>);
