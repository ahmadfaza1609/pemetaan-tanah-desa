        ...
        <div class="col-sm-12 ">
            ...
            <div class="card-style mb-30">
                <div class="col-sm-6  m-auto justify-content-center">
                    <h6 class="mb-30 text-center ">Form Edit Penduduk</h6>
                    <?php
                    // notifikasi form wajib diisi 
                    echo validation_errors('<div class="alert alert-danger alert-dismissible">', '</div>');

                    echo form_open_multipart('penduduk/ubahPenduduk/' . $penduduk->id_penduduk); ?>
                    <div class="input-style-1">
                        <label>NIK</label>
                        <input type="text" name="nik" placeholder="NIK" value="<?= $penduduk->nik ?>" />
                    </div>
                    <div class="input-style-1">
                        <label>Nama Lengkap</label>
                        <input type="text" name="nama" placeholder="Nama Lengkap" value="<?= $penduduk->nama ?>" />
                    </div>
                    <div class="input-style-1">
                    ...
                    <div class="input-style-1">
                        <label>Alamat</label>
                        <input type="text" name="alamat" placeholder="Alamat" value="<?= $penduduk->alamat ?>" />
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                                ...
                                <div class="select-position">
                                    <select name="id_dusun" aria-label="Default select example">
                                        ...
                                        <option value="<?= $value->id_data_dusun ?>"
                                            <?= $value->id_data_dusun == $penduduk->id_dusun ? ' selected' : '' ?>>
                                ...
                                <div class="select-position">
                                    <select name="id_rw" aria-label="Default select example">
                                        ...
                                        <option value="<?= $value->id_data_rw ?>"
                                            <?= $value->id_data_rw == $penduduk->id_rw ? ' selected' : '' ?>>
                                ...
                                <div class="select-position">
                                    <select name="id_rt" aria-label="Default select example">
                                        ...
                                        <option value="<?= $value->id_data_rt ?>"
                                            <?= $value->id_data_rt == $penduduk->id_rt ? ' selected' : '' ?>>
